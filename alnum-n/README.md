# alphanumeric run count, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/alnum-n/mcp
- Official name: `io.github.sadri-dridi/alnum-n`
