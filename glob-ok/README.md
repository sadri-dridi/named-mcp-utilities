# Glob pattern compile, pattern discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/glob-ok/mcp
- Official name: `io.github.sadri-dridi/glob-ok`
