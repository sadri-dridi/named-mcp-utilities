# XML plist dict count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/plist-xml-ok/mcp
- Official name: `io.github.sadri-dridi/plist-xml-ok`
