# whitespace-token charset, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/token-ok/mcp
- Official name: `io.github.sadri-dridi/token-ok`
