# GOST R 34.11 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/gost-len/mcp
- Official name: `io.github.sadri-dridi/gost-len`
