# POSIX shell quote shape, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/shell-esc/mcp
- Official name: `io.github.sadri-dridi/shell-esc`
