# whitespace run length band, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/ws-run/mcp
- Official name: `io.github.sadri-dridi/ws-run`
