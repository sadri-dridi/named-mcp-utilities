# Gradle dependency count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/gradle-ok/mcp
- Official name: `io.github.sadri-dridi/gradle-ok`
