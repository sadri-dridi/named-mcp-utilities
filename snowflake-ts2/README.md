# Snowflake timestamp bits, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/snowflake-ts2/mcp
- Official name: `io.github.sadri-dridi/snowflake-ts2`
