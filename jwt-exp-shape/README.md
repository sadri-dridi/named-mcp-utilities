# JWT exp claim shape, token discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/jwt-exp-shape/mcp
- Official name: `io.github.sadri-dridi/jwt-exp-shape`
