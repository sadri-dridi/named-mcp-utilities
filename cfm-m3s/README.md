# Cubic feet/min to m3/s, number discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/cfm-m3s/mcp
- Official name: `io.github.sadri-dridi/cfm-m3s`
