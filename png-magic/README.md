# PNG magic-byte check, file discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/png-magic/mcp
- Official name: `io.github.sadri-dridi/png-magic`
