# CityHash64 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/city64-len/mcp
- Official name: `io.github.sadri-dridi/city64-len`
