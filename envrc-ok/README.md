# direnv export count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/envrc-ok/mcp
- Official name: `io.github.sadri-dridi/envrc-ok`
