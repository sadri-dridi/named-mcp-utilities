# gitignore rule count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/gitignore-ok/mcp
- Official name: `io.github.sadri-dridi/gitignore-ok`
