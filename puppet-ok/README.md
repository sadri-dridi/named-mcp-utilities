# Puppet class count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/puppet-ok/mcp
- Official name: `io.github.sadri-dridi/puppet-ok`
