# SHA-384 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/sha384-len/mcp
- Official name: `io.github.sadri-dridi/sha384-len`
