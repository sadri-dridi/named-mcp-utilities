# YAML top-level key count, values discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/yaml-keys-ok/mcp
- Official name: `io.github.sadri-dridi/yaml-keys-ok`
