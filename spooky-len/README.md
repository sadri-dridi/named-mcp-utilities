# SpookyHash hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/spooky-len/mcp
- Official name: `io.github.sadri-dridi/spooky-len`
