# Tiger hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/tiger-len/mcp
- Official name: `io.github.sadri-dridi/tiger-len`
