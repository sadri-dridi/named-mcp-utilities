# UPPERCASE run length band, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/upper-run/mcp
- Official name: `io.github.sadri-dridi/upper-run`
