# Firebase push-id time prefix, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/pushid-ts/mcp
- Official name: `io.github.sadri-dridi/pushid-ts`
