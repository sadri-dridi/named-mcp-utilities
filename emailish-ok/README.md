# email-ish local@host shape, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/emailish-ok/mcp
- Official name: `io.github.sadri-dridi/emailish-ok`
