# Discord snowflake id shape, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/discord-id-ok/mcp
- Official name: `io.github.sadri-dridi/discord-id-ok`
