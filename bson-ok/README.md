# BSON document-length band, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/bson-ok/mcp
- Official name: `io.github.sadri-dridi/bson-ok`
