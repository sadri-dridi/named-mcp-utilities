# WebAssembly magic-byte check, file discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/wasm-magic/mcp
- Official name: `io.github.sadri-dridi/wasm-magic`
