# If-Match etag list count, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/if-match-ok/mcp
- Official name: `io.github.sadri-dridi/if-match-ok`
