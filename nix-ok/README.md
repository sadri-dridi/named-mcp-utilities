# Nix attr-set brace count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/nix-ok/mcp
- Official name: `io.github.sadri-dridi/nix-ok`
