# UUID v8 custom layout, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/uuid8-ok/mcp
- Official name: `io.github.sadri-dridi/uuid8-ok`
