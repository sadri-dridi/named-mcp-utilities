# SM3 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/sm3-len/mcp
- Official name: `io.github.sadri-dridi/sm3-len`
