# Fletcher-32 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/fletcher-len/mcp
- Official name: `io.github.sadri-dridi/fletcher-len`
