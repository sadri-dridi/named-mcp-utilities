# LIN-123 identifier shape, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/linear-id-ok/mcp
- Official name: `io.github.sadri-dridi/linear-id-ok`
