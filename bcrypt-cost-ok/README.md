# bcrypt cost prefix check, hash discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/bcrypt-cost-ok/mcp
- Official name: `io.github.sadri-dridi/bcrypt-cost-ok`
