# SHA-512 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/sha512-len/mcp
- Official name: `io.github.sadri-dridi/sha512-len`
