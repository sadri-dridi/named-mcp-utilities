# JSON top-level key count, values discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/json-keys-ok/mcp
- Official name: `io.github.sadri-dridi/json-keys-ok`
