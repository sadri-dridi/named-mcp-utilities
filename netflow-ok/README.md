# NetFlow version nibble, bytes discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/netflow-ok/mcp
- Official name: `io.github.sadri-dridi/netflow-ok`
