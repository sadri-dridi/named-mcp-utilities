# SVG root-tag shape, markup discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/svg-root-ok/mcp
- Official name: `io.github.sadri-dridi/svg-root-ok`
