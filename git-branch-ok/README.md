# Git branch name safety, name discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/git-branch-ok/mcp
- Official name: `io.github.sadri-dridi/git-branch-ok`
