# Grapheme length, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/grapheme-len/mcp
- Official name: `io.github.sadri-dridi/grapheme-len`
