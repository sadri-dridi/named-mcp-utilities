# path/case segment count, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/path-seg/mcp
- Official name: `io.github.sadri-dridi/path-seg`
