# TOML table count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/toml-table-count/mcp
- Official name: `io.github.sadri-dridi/toml-table-count`
