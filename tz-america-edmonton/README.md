...
Current local time in America/Edmonton.
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/tz-america-edmonton/mcp
- Official name: `io.github.sadri-dridi/tz-america-edmonton`
