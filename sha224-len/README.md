# SHA-224 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/sha224-len/mcp
- Official name: `io.github.sadri-dridi/sha224-len`
