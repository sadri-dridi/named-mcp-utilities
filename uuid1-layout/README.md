# UUID v1 time layout, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/uuid1-layout/mcp
- Official name: `io.github.sadri-dridi/uuid1-layout`
