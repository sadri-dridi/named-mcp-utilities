# Discord Webhook Shape

Check a Discord webhook URL shape. Secret discarded.
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/discord-webhook-shape/mcp
- Official name: `io.github.sadri-dridi/discord-webhook-shape`
