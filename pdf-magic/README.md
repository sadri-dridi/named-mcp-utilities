# PDF magic-byte check, file discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/pdf-magic/mcp
- Official name: `io.github.sadri-dridi/pdf-magic`
