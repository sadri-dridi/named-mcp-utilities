# BLAKE2s hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/blake-ok/mcp
- Official name: `io.github.sadri-dridi/blake-ok`
