# True-Client-IP shape, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/true-client/mcp
- Official name: `io.github.sadri-dridi/true-client`
