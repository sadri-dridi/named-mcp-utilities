# dotenv key count, values discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/dotenv-keys/mcp
- Official name: `io.github.sadri-dridi/dotenv-keys`
