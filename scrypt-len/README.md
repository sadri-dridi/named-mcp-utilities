# scrypt hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/scrypt-len/mcp
- Official name: `io.github.sadri-dridi/scrypt-len`
