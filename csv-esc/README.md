# CSV quoted-field count, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/csv-esc/mcp
- Official name: `io.github.sadri-dridi/csv-esc`
