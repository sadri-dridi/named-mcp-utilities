# JSON Pointer token count, path discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/json-ptr-ok/mcp
- Official name: `io.github.sadri-dridi/json-ptr-ok`
