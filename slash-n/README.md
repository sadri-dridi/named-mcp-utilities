# slash-separated token count, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/slash-n/mcp
- Official name: `io.github.sadri-dridi/slash-n`
