# composer.json name shape, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/composer-ok/mcp
- Official name: `io.github.sadri-dridi/composer-ok`
