# path/case segment count, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/path-n/mcp
- Official name: `io.github.sadri-dridi/path-n`
