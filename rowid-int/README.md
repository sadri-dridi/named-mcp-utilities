# integer rowid band, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/rowid-int/mcp
- Official name: `io.github.sadri-dridi/rowid-int`
