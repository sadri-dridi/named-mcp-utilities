# Unicode code-point length, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/unicode-len/mcp
- Official name: `io.github.sadri-dridi/unicode-len`
