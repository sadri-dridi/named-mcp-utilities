# FarmHash64 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/farm64/mcp
- Official name: `io.github.sadri-dridi/farm64`
