# lockfile entry-band, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/lockfile-ok/mcp
- Official name: `io.github.sadri-dridi/lockfile-ok`
