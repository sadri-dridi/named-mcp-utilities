# bcrypt radix64 shape, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/bcrypt-rad/mcp
- Official name: `io.github.sadri-dridi/bcrypt-rad`
