# Python unicode-escape count, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/py-uesc/mcp
- Official name: `io.github.sadri-dridi/py-uesc`
