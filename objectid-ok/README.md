# Mongo ObjectId hex length, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/objectid-ok/mcp
- Official name: `io.github.sadri-dridi/objectid-ok`
