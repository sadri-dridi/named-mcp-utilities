# Helm chart.yaml name shape, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/helm-chart-ok/mcp
- Official name: `io.github.sadri-dridi/helm-chart-ok`
