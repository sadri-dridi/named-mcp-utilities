# multihash sha2 prefix, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/multihash-sha/mcp
- Official name: `io.github.sadri-dridi/multihash-sha`
