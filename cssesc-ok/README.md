# CSS escape sequence count, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/cssesc-ok/mcp
- Official name: `io.github.sadri-dridi/cssesc-ok`
