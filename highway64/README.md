# HighwayHash64 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/highway64/mcp
- Official name: `io.github.sadri-dridi/highway64`
