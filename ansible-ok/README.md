# Ansible hosts group count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/ansible-ok/mcp
- Official name: `io.github.sadri-dridi/ansible-ok`
