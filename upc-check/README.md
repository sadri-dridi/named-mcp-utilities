# UPC-A check-digit shape, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/upc-check/mcp
- Official name: `io.github.sadri-dridi/upc-check`
