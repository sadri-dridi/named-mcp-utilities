# JSON minify shape, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/json-min-ok/mcp
- Official name: `io.github.sadri-dridi/json-min-ok`
