# hosts file token count, line discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/hosts-ok/mcp
- Official name: `io.github.sadri-dridi/hosts-ok`
