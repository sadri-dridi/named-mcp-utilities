# KSUID timestamp prefix, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/ksuid-ts/mcp
- Official name: `io.github.sadri-dridi/ksuid-ts`
