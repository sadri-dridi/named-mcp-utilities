# UUID v5 name layout, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/uuid5-layout/mcp
- Official name: `io.github.sadri-dridi/uuid5-layout`
