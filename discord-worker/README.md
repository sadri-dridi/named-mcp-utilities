# Discord snowflake worker bits, id discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/discord-worker/mcp
- Official name: `io.github.sadri-dridi/discord-worker`
