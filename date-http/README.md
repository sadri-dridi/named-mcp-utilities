# HTTP-date IMF-fixdate shape, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/date-http/mcp
- Official name: `io.github.sadri-dridi/date-http`
