# Argon2i encoded shape, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/argon2i-ok/mcp
- Official name: `io.github.sadri-dridi/argon2i-ok`
