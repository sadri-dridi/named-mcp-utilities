# RTF header check, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/rtf-ok/mcp
- Official name: `io.github.sadri-dridi/rtf-ok`
