# Image alt length band, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/alt-len-ok/mcp
- Official name: `io.github.sadri-dridi/alt-len-ok`
