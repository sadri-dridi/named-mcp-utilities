# MD2 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/md2-len/mcp
- Official name: `io.github.sadri-dridi/md2-len`
