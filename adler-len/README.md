# Adler-32 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/adler-len/mcp
- Official name: `io.github.sadri-dridi/adler-len`
