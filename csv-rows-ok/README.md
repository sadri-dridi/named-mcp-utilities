# CSV data-row count, cells discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/csv-rows-ok/mcp
- Official name: `io.github.sadri-dridi/csv-rows-ok`
