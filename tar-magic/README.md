# TAR ustar check, file discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/tar-magic/mcp
- Official name: `io.github.sadri-dridi/tar-magic`
