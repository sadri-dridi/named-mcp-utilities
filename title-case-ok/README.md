# Title-case token count, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/title-case-ok/mcp
- Official name: `io.github.sadri-dridi/title-case-ok`
