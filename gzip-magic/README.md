# GZIP magic-byte check, file discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/gzip-magic/mcp
- Official name: `io.github.sadri-dridi/gzip-magic`
