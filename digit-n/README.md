# digit run count, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/digit-n/mcp
- Official name: `io.github.sadri-dridi/digit-n`
