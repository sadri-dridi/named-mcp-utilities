# CRC-8 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/crc8-len/mcp
- Official name: `io.github.sadri-dridi/crc8-len`
