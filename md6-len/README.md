# MD6 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/md6-len/mcp
- Official name: `io.github.sadri-dridi/md6-len`
