# label[for] count, markup discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/label-for-ok/mcp
- Official name: `io.github.sadri-dridi/label-for-ok`
