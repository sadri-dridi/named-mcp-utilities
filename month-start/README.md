# UTC start of the current month
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/month-start/mcp
- Official name: `io.github.sadri-dridi/month-start`
