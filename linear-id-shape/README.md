...
Check a Linear issue id shape. Id discarded.
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/linear-id-shape/mcp
- Official name: `io.github.sadri-dridi/linear-id-shape`
