# Snowflake worker-id bits, id discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/snowflake-worker/mcp
- Official name: `io.github.sadri-dridi/snowflake-worker`
