# AsyncAPI channel count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/asyncapi-ok/mcp
- Official name: `io.github.sadri-dridi/asyncapi-ok`
