# Server product-token count, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/server-ok/mcp
- Official name: `io.github.sadri-dridi/server-ok`
