# HighwayHash hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/highway-len/mcp
- Official name: `io.github.sadri-dridi/highway-len`
