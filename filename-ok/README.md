# Safe filename charset, name discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/filename-ok/mcp
- Official name: `io.github.sadri-dridi/filename-ok`
