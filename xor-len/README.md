# XOR-fold length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/xor-len/mcp
- Official name: `io.github.sadri-dridi/xor-len`
