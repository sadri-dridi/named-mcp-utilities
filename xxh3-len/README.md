# XXH3 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/xxh3-len/mcp
- Official name: `io.github.sadri-dridi/xxh3-len`
