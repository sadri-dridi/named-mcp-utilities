# docs path segment count, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/docs-path-ok/mcp
- Official name: `io.github.sadri-dridi/docs-path-ok`
