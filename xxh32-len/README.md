# XXH32 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/xxh32-len/mcp
- Official name: `io.github.sadri-dridi/xxh32-len`
