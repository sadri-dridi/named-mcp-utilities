# Packer source block count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/packer-ok/mcp
- Official name: `io.github.sadri-dridi/packer-ok`
