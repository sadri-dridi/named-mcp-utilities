# BLAKE2b hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/blake2b-len/mcp
- Official name: `io.github.sadri-dridi/blake2b-len`
