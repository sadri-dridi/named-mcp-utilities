# Argon2 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/argon-len/mcp
- Official name: `io.github.sadri-dridi/argon-len`
