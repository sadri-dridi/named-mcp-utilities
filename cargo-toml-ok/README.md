# Cargo.toml package name shape, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/cargo-toml-ok/mcp
- Official name: `io.github.sadri-dridi/cargo-toml-ok`
