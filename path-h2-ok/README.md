# :path absolute-path shape, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/path-h2-ok/mcp
- Official name: `io.github.sadri-dridi/path-h2-ok`
