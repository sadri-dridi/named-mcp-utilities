# UTF-16 code-unit run, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/utf16-run/mcp
- Official name: `io.github.sadri-dridi/utf16-run`
