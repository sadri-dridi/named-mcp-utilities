# If-Range etag-or-date shape, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/if-range-ok/mcp
- Official name: `io.github.sadri-dridi/if-range-ok`
