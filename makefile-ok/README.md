# Makefile target count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/makefile-ok/mcp
- Official name: `io.github.sadri-dridi/makefile-ok`
