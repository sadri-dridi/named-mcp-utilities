# HZ-GB ~{ shift count, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/hzgb-ok/mcp
- Official name: `io.github.sadri-dridi/hzgb-ok`
