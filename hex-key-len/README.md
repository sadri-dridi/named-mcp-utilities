# Hex key length band, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/hex-key-len/mcp
- Official name: `io.github.sadri-dridi/hex-key-len`
