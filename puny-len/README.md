# Punycode output length band, host discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/puny-len/mcp
- Official name: `io.github.sadri-dridi/puny-len`
