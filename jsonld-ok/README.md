# JSON-LD @type count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/jsonld-ok/mcp
- Official name: `io.github.sadri-dridi/jsonld-ok`
