# pyproject.toml table count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/pyproject-ok/mcp
- Official name: `io.github.sadri-dridi/pyproject-ok`
