# Container image tag charset, name discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/image-tag-ok/mcp
- Official name: `io.github.sadri-dridi/image-tag-ok`
