# Terraform block count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/terraform-ok/mcp
- Official name: `io.github.sadri-dridi/terraform-ok`
