# SVG path command count, markup discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/svg-path-ok/mcp
- Official name: `io.github.sadri-dridi/svg-path-ok`
