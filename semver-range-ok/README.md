# SemVer range operators, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/semver-range-ok/mcp
- Official name: `io.github.sadri-dridi/semver-range-ok`
