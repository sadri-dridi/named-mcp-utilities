# host:port shape, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/host-port-ok/mcp
- Official name: `io.github.sadri-dridi/host-port-ok`
