...
Check a MongoDB URL shape. Credentials discarded.
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/mongo-url-shape/mcp
- Official name: `io.github.sadri-dridi/mongo-url-shape`
