# Git SHA hex length, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/git-sha-ok/mcp
- Official name: `io.github.sadri-dridi/git-sha-ok`
