# FarmHash hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/farm-len/mcp
- Official name: `io.github.sadri-dridi/farm-len`
