# xxHash hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/xxhash-len/mcp
- Official name: `io.github.sadri-dridi/xxhash-len`
