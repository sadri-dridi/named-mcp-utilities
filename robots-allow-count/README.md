# robots.txt Allow count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/robots-allow-count/mcp
- Official name: `io.github.sadri-dridi/robots-allow-count`
