# generic flake id digit band, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/flake-ok/mcp
- Official name: `io.github.sadri-dridi/flake-ok`
