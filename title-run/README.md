# Title Case token length band, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/title-run/mcp
- Official name: `io.github.sadri-dridi/title-run`
