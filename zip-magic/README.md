# ZIP magic-byte check, file discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/zip-magic/mcp
- Official name: `io.github.sadri-dridi/zip-magic`
