# SHA-3 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/sha3-ok/mcp
- Official name: `io.github.sadri-dridi/sha3-ok`
