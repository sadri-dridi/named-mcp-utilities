# SQLite rowid integer band, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/rowid-ok/mcp
- Official name: `io.github.sadri-dridi/rowid-ok`
