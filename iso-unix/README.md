# ISO date to unix seconds, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/iso-unix/mcp
- Official name: `io.github.sadri-dridi/iso-unix`
