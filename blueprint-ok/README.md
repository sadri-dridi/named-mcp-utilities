# API Blueprint group count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/blueprint-ok/mcp
- Official name: `io.github.sadri-dridi/blueprint-ok`
