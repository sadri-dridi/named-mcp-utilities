# tsconfig compilerOptions count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/tsconfig-ok/mcp
- Official name: `io.github.sadri-dridi/tsconfig-ok`
