# Python identifier charset, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/ident-py/mcp
- Official name: `io.github.sadri-dridi/ident-py`
