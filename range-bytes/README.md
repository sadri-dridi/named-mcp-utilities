# Range bytes start-end shape, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/range-bytes/mcp
- Official name: `io.github.sadri-dridi/range-bytes`
