# RIPEMD hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/ripemd-len/mcp
- Official name: `io.github.sadri-dridi/ripemd-len`
