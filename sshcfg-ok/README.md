# ssh config Host count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/sshcfg-ok/mcp
- Official name: `io.github.sadri-dridi/sshcfg-ok`
