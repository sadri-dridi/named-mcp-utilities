# Poly1305 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/poly-len/mcp
- Official name: `io.github.sadri-dridi/poly-len`
