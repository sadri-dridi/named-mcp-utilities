# JSON5 comment/key shape, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/json5-ok/mcp
- Official name: `io.github.sadri-dridi/json5-ok`
