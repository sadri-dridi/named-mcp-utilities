# Google UUID timeuuid layout, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/guuid-ok/mcp
- Official name: `io.github.sadri-dridi/guuid-ok`
