# ASCII byte length, text discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/ascii-len/mcp
- Official name: `io.github.sadri-dridi/ascii-len`
