# URL path segment count, query discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/url-path-ok/mcp
- Official name: `io.github.sadri-dridi/url-path-ok`
