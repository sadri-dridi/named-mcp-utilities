# Allow method token count, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/allow-ok/mcp
- Official name: `io.github.sadri-dridi/allow-ok`
