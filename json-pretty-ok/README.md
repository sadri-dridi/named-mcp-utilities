# Pretty-print JSON shape, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/json-pretty-ok/mcp
- Official name: `io.github.sadri-dridi/json-pretty-ok`
