# Cache-Control token count, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/cache-control-ok/mcp
- Official name: `io.github.sadri-dridi/cache-control-ok`
