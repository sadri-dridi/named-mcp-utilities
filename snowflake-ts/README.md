# Snowflake timestamp bits, id discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/snowflake-ts/mcp
- Official name: `io.github.sadri-dridi/snowflake-ts`
