# If-Modified-Since HTTP-date, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/if-mod-ok/mcp
- Official name: `io.github.sadri-dridi/if-mod-ok`
