# Revolutions per second to hertz, number discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/rps-hz/mcp
- Official name: `io.github.sadri-dridi/rps-hz`
