# SHA-1 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/sha1-len/mcp
- Official name: `io.github.sadri-dridi/sha1-len`
