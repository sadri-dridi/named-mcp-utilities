# CSV header count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/csv-header-ok/mcp
- Official name: `io.github.sadri-dridi/csv-header-ok`
