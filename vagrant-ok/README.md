# Vagrant config block count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/vagrant-ok/mcp
- Official name: `io.github.sadri-dridi/vagrant-ok`
