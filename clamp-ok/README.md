# Clamp n into [min,max], numbers discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/clamp-ok/mcp
- Official name: `io.github.sadri-dridi/clamp-ok`
