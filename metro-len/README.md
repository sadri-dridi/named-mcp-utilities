# MetroHash hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/metro-len/mcp
- Official name: `io.github.sadri-dridi/metro-len`
