# MurmurHash3 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/murmur3-len/mcp
- Official name: `io.github.sadri-dridi/murmur3-len`
