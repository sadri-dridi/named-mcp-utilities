# Feather magic-byte check, file discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/feather-ok/mcp
- Official name: `io.github.sadri-dridi/feather-ok`
