# BLAKE3 hex length, input discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/blake3-len/mcp
- Official name: `io.github.sadri-dridi/blake3-len`
