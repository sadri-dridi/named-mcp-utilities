# INI key count, values discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/ini-keys-ok/mcp
- Official name: `io.github.sadri-dridi/ini-keys-ok`
