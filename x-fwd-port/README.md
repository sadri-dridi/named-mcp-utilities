# X-Forwarded-Port integer band, value discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/x-fwd-port/mcp
- Official name: `io.github.sadri-dridi/x-fwd-port`
