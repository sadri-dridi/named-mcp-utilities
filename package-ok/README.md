# package.json key count, body discarded
...
- MCP: https://agent-observatory-sensor.nolimit-observatory.workers.dev/s/package-ok/mcp
- Official name: `io.github.sadri-dridi/package-ok`
